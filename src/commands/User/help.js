...
module.exports = class extends Command {
	...
	async run(msg, [cmd]) {
		...
		return msg[method].send(helpMessage, { split: { char: '\u200b' } })
			.then(() => { if (msg.channel.type !== 'dm' && this.client.user.bot) msg.affirm(msg.language.get('COMMAND_HELP_DM')); })
			.catch(() => { if (msg.channel.type !== 'dm' && this.client.user.bot) msg.reject(msg.language.get('COMMAND_HELP_NODM')); });
	}
