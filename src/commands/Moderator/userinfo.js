...
module.exports = class extends Command {
	...
	async run(msg, [member = msg.member]) {
		...
		const embed = new MessageEmbed()
			...
			.addField(msg.guild.language.get('JOINED'), `${this.timestamp.displayUTC(member.joinedTimestamp)} (UTC)`, true)
			.addField(msg.guild.language.get('REGISTERED'), `${this.timestamp.displayUTC(member.user.createdAt)} (UTC)`, true)
