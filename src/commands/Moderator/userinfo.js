...
module.exports = class extends Command {
	...
	async run(msg, [member = msg.member]) {
		...
		const embed = new MessageEmbed()
			...
			.addField(msg.guild.language.get('COMMAND_USERINFO_REGISTERED'), this.timestamp.display(member.user.createdAt), true)
			.addField(msg.guild.language.get('COMMAND_USERINFO_JOINED'), this.timestamp.display(member.joinedTimestamp), true)
