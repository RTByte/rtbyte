...
module.exports = class extends Command {
	...
	async run(msg, [user, ...reason]) {
		...
		if (msg.guild.configs.logs.guildMemberKick) await this.warnLog(member, reason);
	...
	async ensureGuildVars() {
		...
		if (!this.client.gateways.guilds.schema.logs.has('guildMemberWarn')) await this.client.gateways.guilds.schema.logs.add('guildMemberWarn', { type: 'Boolean', array: false, default: true });
		return;
	}
