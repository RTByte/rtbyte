...
module.exports = class extends Command {
	...
	async run(msg) {
		const embed = new MessageEmbed()
			...
			.addField(msg.guild.language.get('COMMAND_STATS_CONNECTIONS'), msg.guild.language.get('COMMAND_STATS_CONNECTIONINFO', this.client.guilds.size, this.client.channels.size, this.client.users.size), true)
			// eslint-disable-next-line max-len
