...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_SETTINGS_SET_ONLYSPECIFIED: 'You can only use the `set` subcommand with `units`, `timezone`, or `roles`.',
			COMMAND_SETTINGS_SET_NOSUBSETTINGALLOWED: "You can't use any subsettings when modifying `units` or `timezone`.",
