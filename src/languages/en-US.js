...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_AUTORESPONDER_DESCRIPTION: 'A series of commands to let you manage automatic responses for keywords and phrases.',
			COMMAND_AUTORESPONDER_EXTENDEDHELP: (prefix = `-`) => [
				`• To enable or disable the autoresponder, run \`${prefix}autoresponder enable\` or \`${prefix}autoresponder disable\``,
				`• To create an autoresponse, run \`${prefix}autoresponder create <keyword or phrase> <response>\``,
				`• To delete an autoresponse, run \`${prefix}autoresponder delete <keyword or phrase>\``,
				`• To update an autoresponse, run \`${prefix}autoresponder update <keyword or phrase> <new response>\``
			],
			COMMAND_AUTORESPONDER_NOTEXIST: (name) => `An automatic response for the keyword or phrase \`${name}\` does not exist in this server.`,
			COMMAND_AUTORESPONDER_SHOW_TITLE: 'Autoresponder settings',
			COMMAND_AUTORESPONDER_SHOW_RESPONSES: 'Automatic responses',
			COMMAND_AUTORESPONDER_ENABLE_ALREADYENABLED: 'Automatic responses are already enabled.',
			COMMAND_AUTORESPONDER_ENABLE_SUCCESS: 'Automatic responses have been enabled.',
			COMMAND_AUTORESPONDER_DISABLE_ALREADYDISABLED: 'Automatic responses are already disabled.',
			COMMAND_AUTORESPONDER_DISABLE_SUCCESS: 'Automatic responses have been disabled.',
			COMMAND_AUTORESPONDER_CREATE_NONAME: "Please provide a keyword or enquoted phrase for the automatic response you'd like to create.",
			COMMAND_AUTORESPONDER_CREATE_NOCONTENT: "Please provide the response for the automatic response you'd like to create.",
			COMMAND_AUTORESPONDER_CREATE_ALREADYEXISTS: (name) => `The automatic response for the keyword or phrase \`${name}\` already exists in this server.`,
			COMMAND_AUTORESPONDER_DELETE_NONAME: "Please provide the keyword or enquoted phrase for the automatic response you'd like to delete.",
			COMMAND_AUTORESPONDER_NOSETTING: 'You need to specify what setting you want to modify (`ignored`).',
			COMMAND_AUTORESPONDER_NOVALUE_CHANNEL: 'You need to specify a channel.',
			COMMAND_AUTORESPONDER_SET_IGNORED_ALREADYADDED: (channel) => `${channel} is already on the autoresponder's ignored channels list.`,
			COMMAND_AUTORESPONDER_REMOVE_ONLYIGNORED: "You can only use the `remove` option when modifying the autoresponder's ignored channels list.",
			COMMAND_AUTORESPONDER_REMOVE_NOTADDED: (channel) => `${channel} is not on the autoresponder's list of ignored channels.`,
			COMMAND_AUTORESPONDER_RESET_IGNORED_NOTSET: "No channels have beeen added to the autoresponder's ignored channels list, so you can't reset it.",
			...
			COMMAND_LOGS_SHOW_COMMANDRUN: 'Command ran \n`(cmdrun)`',
			...
			COMMAND_LOGS_SHOW_AUTORESPONSEDELETE: 'Automatic response created \n`(autoresponsecreate)`',
			COMMAND_LOGS_SHOW_AUTORESPONSECREATE: 'Automatic response deleted \n`(autoresponsedelete)`',
			COMMAND_LOGS_SHOW_AUTORESPONSEUPDATE: 'Automatic response updated \n`(autoresponseupdate)`',
			...
			GUILD_LOG_AUTORESPONSECREATE: (executor) => `Automatic response created${executor ? ` by ${executor.tag}` : ''}`,
			GUILD_LOG_AUTORESPONSECREATE_RESPONSE: 'Automatic response',
			GUILD_LOG_AUTORESPONSEDELETE: (executor) => `Automatic response deleted${executor ? ` by ${executor.tag}` : ''}`,
			GUILD_LOG_AUTORESPONSEUPDATE: (executor) => `Automatic response updated${executor ? ` by ${executor.tag}` : ''}`,
			GUILD_LOG_AUTORESPONSEUPDATE_OLD: 'Old automatic response',
			GUILD_LOG_AUTORESPONSEUPDATE_NEW: 'New automatic response',
