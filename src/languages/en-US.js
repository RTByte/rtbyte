...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_LOGS_ENABLE_ONLY_EVENT: 'You can only use the `enable` subcommand with a log event (refer to `-logs` for a list).',
			COMMAND_LOGS_ENABLE_ALREADYENABLED: (event) => `The \`${event}\` log is already enabled.`,
			COMMAND_LOGS_DISABLE_ONLY_EVENT: 'You can only use the `disable` subcommand with a log event (refer to `-logs` for a list).',
