...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_CREATECMD_NOPARAM_NAME: "Please provide a name for the custom command you'd like to create.",
			COMMAND_CREATECMD_NOPARAM_CONTENT: "Please provide the response for the custom command you'd like to create.",
			COMMAND_CREATECMD_NOTENABLED: "Custom commands aren't enabled in this server.",
			...
			COMMAND_DELETECMD_NOPARAM: "Please provide the name of the custom command you'd like to delete.",
			COMMAND_DELETECMD_NOTENABLED: "Custom commands aren't enabled in this server.",
			COMMAND_UPDATECMD_DESCRIPTION: 'Updates an existing custom command in the server.',
			COMMAND_UPDATECMD_NOPARAM_NAME: "Please provide the name of the custom command you'd like to update.",
			COMMAND_UPDATECMD_NOPARAM_CONTENT: "Please provide the new response for the custom command you'd like to update.",
			COMMAND_UPDATECMD_NOTENABLED: "Custom commands aren't enabled in this server.",
