...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_PINBOARD_ENABLE_SUCCESS: 'The pinboard has been enabled.',
			COMMAND_PINBOARD_DISABLE_ALREADYDISABLED: 'The pinboard is already disabled.',
			COMMAND_PINBOARD_DISABLE_SUCCESS: 'The pinboard has been disabled.',
			COMMAND_PINBOARD_SET_CHANNEL_SAMECHANNEL: (channel) => `The pinboard channel is already set to ${channel}.`,
			COMMAND_PINBOARD_SET_CHANNEL_SUCCESS: (channel) => `The pinboard channel has been set to ${channel}`,
			COMMAND_PINBOARD_SET_IGNORED_ALREADYADDED: (channel) => `${channel} is already on the pinboard's ignored channels list.`,
			COMMAND_PINBOARD_SET_IGNORED_SUCCESS: (channel) => `${channel} has been added to the pinboard's ignored channels list.`,
			...
			COMMAND_PINBOARD_REMOVE_SUCCESS: (channel) => `${channel} has been removed from the pinboard's ignored channels list.`,
			...
			COMMAND_PINBOARD_RESET_CHANNEL_SUCCESS: 'The pinboard channel has been reset.',
			COMMAND_PINBOARD_RESET_IGNORED_SUCCESS: "The pinboard's ignored channels list has been reset.",
			...
			COMMAND_STARBOARD_ENABLE_SUCCESS: 'The starboard has been enabled.',
			COMMAND_STARBOARD_DISABLE_ALREADYDISABLED: 'The starboard is already disabled.',
			COMMAND_STARBOARD_DISABLE_SUCCESS: 'The starboard has been disabled.',
			COMMAND_STARBOARD_SET_THRESHOLD_SAMEVALUE: (threshold) => `The starboard's star threshold is already set to \`${threshold}\`.`,
			COMMAND_STARBOARD_SET_THRESHOLD_SUCCESS: (threshold) => `The starboard's star threshold has been set to \`${threshold}\`.`,
			COMMAND_STARBOARD_SET_CHANNEL_SAMECHANNEL: (channel) => `The starboard channel is already set to ${channel}.`,
			COMMAND_STARBOARD_SET_CHANNEL_SUCCESS: (channel) => `The starboard channel has been set to ${channel}.`,
			COMMAND_STARBOARD_SET_IGNORED_ALREADYADDED: (channel) => `${channel} is already on the starboard's ignored channels list.`,
			COMMAND_STARBOARD_SET_IGNORED_SUCCESS: (channel) => `${channel} has been added to the starboard's ignored channels list.`,
			...
			COMMAND_STARBOARD_REMOVE_SUCCESS: (channel) => `${channel} has been removed from the starboard's ignored channels list.`,
			...
			COMMAND_STARBOARD_RESET_THRESHOLD_SUCCESS: "The starboard's star threshold has been reset back to it's default value.",
			COMMAND_STARBOARD_RESET_CHANNEL_SUCCESS: 'The starboard channel has been reset.',
			COMMAND_STARBOARD_RESET_IGNORED_SUCCESS: "The starboard's ignored channels list has been reset.",
			...
			COMMAND_GREETINGS_SHOW_TITLE: 'Greetings settings',
			...
			COMMAND_GREETINGS_ENABLE_SUCCESS: (setting) => `${setting === 'welcomeNewUsers' ? 'Welcoming new members' : setting === 'dismissUsers' ? 'Dismissal of leaving members' : ''} has been enabled.`,
			...
			// eslint-disable-next-line max-len
			COMMAND_GREETINGS_DISABLE_SUCCESS: (setting) => `${setting === 'welcomeNewUsers' ? 'Welcoming new members' : setting === 'dismissUsers' ? 'Dismissal of leaving members' : ''} has been disabled.`,
			...
			COMMAND_GREETINGS_SET_WELCOMECHANNEL_SUCCESS: (channel) => `The welcome channel has been set to ${channel}.`,
			COMMAND_GREETINGS_SET_WELCOMEMESSAGE_SUCCESS: (message) => `The welcome message has been set to:\n${message}`,
			COMMAND_GREETINGS_SET_DISMISSCHANNEL_SUCCESS: (channel) => `The dismissal channel has been set to ${channel}.`,
			COMMAND_GREETINGS_SET_DISMISSMESSAGE_SUCCESS: (message) => `The dismissal message has been set to:\n${message}`,
			...
			COMMAND_GREETINGS_RESET_WELCOMECHANNEL_SUCCESS: 'The welcome channel has been reset.',
			COMMAND_GREETINGS_RESET_WELCOMEMESSAGE_SUCCESS: 'The welcome message has been reset.',
			COMMAND_GREETINGS_RESET_DISMISSCHANNEL_SUCCESS: 'The dismissal channel has been reset.',
			COMMAND_GREETINGS_RESET_DISMISSMESSAGE_SUCCESS: 'The dismissal message has been reset.',
