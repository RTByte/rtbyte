...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_ROLES_NOT_JOINABLE: (roleName) => `Nice try, the role \`${roleName}\` is not joinable in this server.`,
			...
			COMMAND_MODERATION_BOILERPLATE: (guild) => `This action was performed by a moderator of ${guild.name} Discord.`,
