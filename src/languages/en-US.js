...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_AUTORESPONDER_DESCRIPTION: 'A series of commands to let you manage automatic responses for keywords.',
			COMMAND_AUTORESPONDER_EXTENDEDHELP: (prefix = `-`) => [
				...
				`• To create an autoresponse, run \`${prefix}autoresponder create <keyword> <response>\``,
				`• To delete an autoresponse, run \`${prefix}autoresponder delete <keyword>\``,
				`• To update an autoresponse, run \`${prefix}autoresponder update <keyword> <new response>\``
			],
			COMMAND_AUTORESPONDER_NOTEXIST: (name) => `An automatic response for the keyword \`${name}\` does not exist in this server.`,
			...
			COMMAND_AUTORESPONDER_CREATE_NONAME: "Please provide a keyword for the automatic response you'd like to create.",
			COMMAND_AUTORESPONDER_CREATE_NOCONTENT: "Please provide the response for the automatic response you'd like to create.",
			COMMAND_AUTORESPONDER_CREATE_ALREADYEXISTS: (name) => `The automatic response for the keyword \`${name}\` already exists in this server.`,
			COMMAND_AUTORESPONDER_DELETE_NONAME: "Please provide the keyword for the automatic response you'd like to delete.",
