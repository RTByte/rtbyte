...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_HELP_DM: (affirmEmoji) => `${affirmEmoji} The list of commands you have access to has been sent to your DMs.`,
			COMMAND_HELP_NODM: (rejectEmoji) => `${rejectEmoji} You have DMs disabled, I couldn't send you the commands in DMs.`,
			...
			COMMAND_MODERATION_NOT_MODABLE: (rejectEmoji, target) => `${rejectEmoji} You are not allowed to moderate ${target}.`,
			...
			COMMAND_ROLES_DOES_NOT_EXIST: (rejectEmoji, roleName) => `${rejectEmoji} Sorry, the role \`${roleName}\` does not exist in this server. Please check to make sure you spelled it correctly.`,
			COMMAND_ROLES_NOT_JOINABLE: (rejectEmoji, roleName) => `${rejectEmoji} Nice try, the role \`${roleName}\` is not joinable in this server.`,
			COMMAND_ROLES_ALREADY_HAVE: (rejectEmoji, roleName, target) => `${rejectEmoji} ${target} already has the role \`${roleName}\`.`,
			COMMAND_ROLES_NOT_LEAVABLE: (rejectEmoji, roleName) => `${rejectEmoji} You're not allowed to remove the role \`${roleName}\`.`,
			COMMAND_ROLES_DOES_NOT_HAVE: (rejectEmoji, roleName, target) => `${rejectEmoji} ${target} does not have the role \`${roleName}\`.`,
			...
			COMMAND_MUTE_NO_MUTE_SELF: 'Why would you mute yourself?',
			COMMAND_MUTE_NO_MUTE_CLIENT: 'Have I done something wrong?',
			COMMAND_MUTE_NO_PERMS: (user) => `You don't have permission to mute ${user}.`,
			COMMAND_UNMUTE_DESCRIPTION: 'Unmutes a mentioned user.',
			COMMAND_UNMUTE_NO_UNMUTE_SELF: 'You can\'t unmute yourself.',
			COMMAND_UNMUTE_NO_UNMUTE_CLIENT: 'Why was I muted?',
