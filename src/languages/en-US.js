...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_GREETINGS_NOSETTING: 'You need to specify what setting you want to modify (`welcomechannel`, `welcomemessage`, `dismisschannel`, or `dismissmessage`).',
			...
			COMMAND_GREETINGS_SHOW_WELCOMEENABLED: 'Welcome enabled',
			COMMAND_GREETINGS_SHOW_DISMISSENABLED: 'Dismissal enabled',
			...
			COMMAND_GREETINGS_ONLY_WELCCH_DISCH_WELCMSG_DISMSG: 'You can only use the `set` and `reset` subcommands with `welcomechannel`, `welcomemessage`, `dismisschannel`, or `dismissmessage`.',
			...
			COMMAND_LOGS_SHOW_MESSAGEDELETE: 'Message deleted `(msgdelete)`',
			COMMAND_LOGS_SHOW_MESSAGEUPDATE: 'Message edited `(msgedit)`',
			COMMAND_LOGS_SHOW_GUILDUPDATE: 'Server updated `(serverupdate)`',
			COMMAND_LOGS_SHOW_INVITECREATE: 'Invite created `(invitecreate)`',
			COMMAND_LOGS_SHOW_INVITEDELETE: 'Invite deleted `(invitedelete)`',
			COMMAND_LOGS_SHOW_CHANNELCREATE: 'Channel created `(channelcreate)`',
			COMMAND_LOGS_SHOW_CHANNELDELETE: 'Channel deleted `(channeldelete)`',
			COMMAND_LOGS_SHOW_CHANNELUPDATE: 'Channel updated `(channelupdate)`',
			COMMAND_LOGS_SHOW_ROLECREATE: 'Role created `(rolecreate)`',
			COMMAND_LOGS_SHOW_ROLEDELETE: 'Role deleted `(roledelete)`',
			COMMAND_LOGS_SHOW_ROLEUPDATE: 'Role updated `(roleupdate)`',
			COMMAND_LOGS_SHOW_EMOJICREATE: 'Emoji created `(emojicreate)`',
			COMMAND_LOGS_SHOW_EMOJIDELETE: 'Emoji deleted `(emojidelete)`',
			COMMAND_LOGS_SHOW_EMOJIUPDATE: 'Emoji updated `(emojiupdate)`',
			COMMAND_LOGS_SHOW_WEBHOOKCREATE: 'Webhook created `(webhookcreate)`',
			COMMAND_LOGS_SHOW_WEBHOOKDELETE: 'Webhook deleted `(webhookdelete)`',
			COMMAND_LOGS_SHOW_WEBHOOKUPDATE: 'Webhook updated `(webhookupdate)`',
			COMMAND_LOGS_SHOW_CUSTOMCMDDELETE: 'Custom command created `(customcmdcreate)`',
			COMMAND_LOGS_SHOW_CUSTOMCMDCREATE: 'Custom command deleted `(customcmddelete)`',
			COMMAND_LOGS_SHOW_CUSTOMCMDUPDATE: 'Custom command updated `(customcmdupdate)`',
			COMMAND_LOGS_SHOW_GUILDMEMBERADD: 'Member joins `(memberjoin)`',
			COMMAND_LOGS_SHOW_GUILDBOTADD: 'Bot is added `(botadd)`',
			COMMAND_LOGS_SHOW_GUILDMEMBERREMOVE: 'Member leaves `(memberleave)`',
			COMMAND_LOGS_SHOW_GUILDMEMBERUPDATE: 'Member updated `(memberupdate)`',
			COMMAND_LOGS_SHOW_GUILDBOOSTADD: 'Nitro-boost added `(nitroadd)`',
			COMMAND_LOGS_SHOW_GUILDBOOSTREMOVE: 'Nitro-boost removed `(nitroremove)`',
			COMMAND_LOGS_SHOW_GUILDBOOSTTIERUPDATE: 'Server boost level updated `(nitrolvlupdate)`',
			...
			COMMAND_FILTERS_SHOW_PUNISHMENT: 'Punishment',
			...
			COMMAND_MODERATION_SHOW_NOTIFYUSER: 'Notify user of moderation action `(notify)`',
			COMMAND_MODERATION_SHOW_PURGE: 'Messages purged `(purge)`',
			COMMAND_MODERATION_SHOW_WARN: 'Warning issued `(warn)`',
			COMMAND_MODERATION_SHOW_MUTE: 'Member muted `(mute)`',
			COMMAND_MODERATION_SHOW_UNMUTE: 'Member unmuted `(unmute)`',
			COMMAND_MODERATION_SHOW_KICK: 'Member kicked `(kick)`',
			COMMAND_MODERATION_SHOW_SOFTBAN: 'Member softbanned `(softban)`',
			COMMAND_MODERATION_SHOW_BAN: 'Member banned `(ban)`',
			COMMAND_MODERATION_SHOW_UNBAN: 'Member unbanned `(unban)`',
			COMMAND_MODERATION_SHOW_VCKICK: 'Member kicked from voice chat `(vckick)`',
			COMMAND_MODERATION_SHOW_VCBAN: 'Member banned from voice chat `(vcban)`',
			COMMAND_MODERATION_SHOW_VCUNBAN: 'Member unbanned from voice chat `(vcunban)`',
			COMMAND_MODERATION_SHOW_ANTIINVITE: 'Anti-invite filter triggered `(antiinvite)`',
			COMMAND_MODERATION_SHOW_MENTIONSPAM: 'Mention spam filter triggered `(mentionspam)`',
			COMMAND_MODERATION_SHOW_BLACKLISTEDWORD: 'Blacklisted word filter triggered `(blacklistedword)`',
			COMMAND_MODERATION_SHOW_BLACKLISTEDNICKNAME: 'Blacklisted name filter triggered `(blacklistedname)`',
			...
			COMMAND_SETTINGS_SHOW_PREFIX: 'Prefix `(prefix)`',
			COMMAND_SETTINGS_SHOW_LANGUAGE: 'Language `(language)`',
			...
			COMMAND_SETTINGS_SHOW_TIMEZONE: 'Timezone `(timezone)`',
			COMMAND_SETTINGS_SHOW_COMMANDANALYTICS: 'Command analytics `(commandanalytics)`',
			COMMAND_SETTINGS_SHOW_DEVELOPERSARESUPERUSERS: 'Developers are superusers `(devsaresuperusers)`',
			COMMAND_SETTINGS_SHOW_SERVERINFOEXTENDEDOUTPUT: 'Serverinfo extended output `(sinfoextendedoutput)`',
			COMMAND_SETTINGS_SHOW_ADMINISTRATOR: 'Administrator role `(admin)`',
			COMMAND_SETTINGS_SHOW_MODERATOR: 'Moderator role `(mod)`',
			COMMAND_SETTINGS_SHOW_MUTED: 'Muted role `(muted)`',
			COMMAND_SETTINGS_SHOW_VOICEBANNED: 'Voice chat banned role `(vcbanned)`',
			COMMAND_SETTINGS_SHOW_JOINABLE: 'Joinable roles `(joinable)`',
