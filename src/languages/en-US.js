...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_PINBOARD_SHOW_ENABLED: 'Enabled',
			COMMAND_PINBOARD_SHOW_IGNORED: 'Ignored channels',
			...
			COMMAND_PINBOARD_REMOVE_ONLYIGNORED: 'You can only use the `remove` option when modifying the ignored channels list.',
