...
export class UserListener extends Listener {
	...
	private serverLog(sticker: Sticker, executor: User | null | undefined, t: TFunction) {
		const embed = new GuildLogEmbed()
			...
			.setFooter(t(LanguageKeys.Events.Guilds.Logs.StickerCreated, { by: executor ? t(LanguageKeys.Miscellaneous.By, { user: executor?.tag }) : undefined }), executor?.displayAvatarURL() ?? undefined)
