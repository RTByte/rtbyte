...
export const DurationValueFuture = FT<{ value: number }, string>('globals:durationValueFuture');
export const DurationValuePast = FT<{ value: number }, string>('globals:durationValuePast');
